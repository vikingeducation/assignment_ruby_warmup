...
puts stock_picker([44, 30, 24, 32, 35, 30, 40, 38, 15]) # returns [2,6], the solution to the original problem.

# returns [8, 13], an input value my interview solution would've failed.
puts stock_picker([44, 30, 24, 32, 35, 30, 40, 38, 15, 16, 17, 18, 17, 90295])
